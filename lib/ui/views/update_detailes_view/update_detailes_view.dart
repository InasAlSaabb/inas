    ...
    return Scaffold(
      ...
      child: Column(
        children: [
          ...
          (screenWidth(25)).ph,
          CustomTextField(
            hintcolor: AppColors.mainpurple1,
            iconcolor: AppColors.mainpurple1,
            preficoncolor: AppColors.mainpurple1,
            fill: AppColors.mainskycolor,
          ...
          CustomTextField(
              ...
              preficoncolor: AppColors.mainpurple1,
              iconcolor: AppColors.mainpurple1,
              prefixIconColor: AppColors.mainpurple1,
              fill: AppColors.mainskycolor,
              validator: (value) {
                if (value!.isEmpty) {
